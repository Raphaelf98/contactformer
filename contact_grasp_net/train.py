...
def test(ContactGraspNet, global_config, log_dir, FLAGS):
...
if __name__=="__main__":
    ...
    parser.add_argument('--overwrite_ckpt_dir', type=bool, default=False, help='0, 1') # applies changes in contact_grasp_dir to files in checkpoint_dir. Attention: This will overwrite files in checkpoint_dir
    parser.add_argument('--model', type=str, required=True, help='ptv2, ptv3')
    parser.add_argument('--debug', type=bool, default=False, help='0, 1')
    ...
    test(ContactGraspNet, global_config, checkpoint_dir, FLAGS)
